...
import { AtSignIcon, ChevronLeftIcon, Circle, Loader2 } from "lucide-react";
	...
	return (
		<main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
			<div className="relative hidden h-full flex-col border-r bg-secondary p-10 lg:flex dark:bg-secondary/20">
				...
				<Circle className="mr-auto h-5" />
				<h1 className="mr-auto h-5">Unique Dotz</h1>
			...
			<div className="relative flex min-h-screen flex-col justify-center p-4">
				...
				<div className="mx-auto space-y-4 sm:w-sm">
					...
					<form className="space-y-2" onSubmit={handleMagicLinkSignIn}>
...
function AppleIcon({
	...
	return (
		<svg fill={fill} viewBox="0 0 24 24" height="18" width="18" {...props}>
			<g id="_Group_2">
				<g id="_Group_3">
					<path
...
const GithubIcon = (props: React.ComponentProps<"svg">) => (
	<svg fill="currentColor" viewBox="0 0 1024 1024" height="18" width="18" {...props}>
		<path
			clipRule="evenodd"
